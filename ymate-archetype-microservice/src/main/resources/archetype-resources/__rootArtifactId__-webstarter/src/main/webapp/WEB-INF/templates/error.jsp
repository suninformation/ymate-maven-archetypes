...
<head>
    ...
    <style type="text/css">
        ...
        body {
            ...
            margin: 0;
            background-color: ${symbol_pound}303030;
        }
        ...
        @media (max-width: 720px) {
            ${symbol_pound}subtitle > .learn-more-button {
                display: none;
            }
        ...
        @media (min-width: 720px) {
            .icon, h1, ${symbol_pound}subtitle, .learn-more-button {
            ...
            @media (max-height: 320px) {
                h1, ${symbol_pound}subtitle, .learn-more-button {
                    margin-bottom: 16px;
                    margin-top: 16px;
                }
